...
public class BluetoothLEHelper {
    ...
    public void write(String service, String characteristic, byte[] aBytes){
        ...
        mBluetoothGattCharacteristic = mBluetoothGatt.getService(UUID.fromString(service))
    ...
    public void read(String service, String characteristic){
        mBluetoothGatt.readCharacteristic(mBluetoothGatt.getService(UUID.fromString(service))
                .getCharacteristic(UUID.fromString(characteristic)));
